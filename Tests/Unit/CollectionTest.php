...
class CollectionTest extends TestCase{
  ...
  public function collection_can_be_merged_with_another_collection(){
    ...
    // $this->assertCount(5, $mergedcollection->get());
    // $this->assertEquals(5, $mergedcollection->count());
  ...
  public function returns_json_encodes_items(){
    $collection = new \App\Support\Collection([
      ['username'=>'sai'],
      ['username'=>'nag'],
    ]);
    ...
    $this->assertEquals('[{"username":"sai"},{"username":"nag"}]', $collection->toJSON());
  ...
  public function json_encoding_a_collection_object_returns_json(){
    ...
    $this->assertEquals('[{"username":"sai"},{"username":"nag"}]', $encoded);
